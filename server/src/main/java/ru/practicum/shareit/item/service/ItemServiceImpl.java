...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto add(ItemDto itemDto, long userId) {
        ...
        Item newItem = new Item(
                ...
                userId,
                itemDto.getItemRequestId() == null ? null : itemRequestRepository.findById(itemDto.getItemRequestId())
    ...
    @Override
    public CommentDto addComment(CommentPostDto commentPostDto, long itemId, long userId, LocalDateTime now) {
