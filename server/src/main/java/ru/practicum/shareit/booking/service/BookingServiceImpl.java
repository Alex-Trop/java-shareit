...
public class BookingServiceImpl implements BookingService {
    ...
    public List<BookingDto> getUserBookings(String stateParam, long userId, LocalDateTime now) {
    ...
    public List<BookingDto> getOwnerBookings(String stateParam, long userId, LocalDateTime now) {
        BookingState state = BookingState.of(stateParam)
                .orElseThrow(() -> new RuntimeException(INVALID_PARAMETER));
